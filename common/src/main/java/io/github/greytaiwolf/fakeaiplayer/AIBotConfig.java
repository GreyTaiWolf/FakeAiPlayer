...
import io.github.greytaiwolf.fakeaiplayer.mode.OperatorCapabilities;
...
import io.github.greytaiwolf.fakeaiplayer.mode.ProfileResolver;
...
public record AIBotConfig(
    ...
    public static AIBotConfig load() {
        Path path = PlatformServices.configDirectory().resolve("fakeaiplayer.json");
